# medios — instrucciones para Codex

## Triggers — cuando aplicar estas instrucciones

Aplicar cuando el usuario pida: agenda del día, noticias argentinas, qué pasó hoy, cómo cubre [X] medio, verificar afirmación, fact check, contexto de noticia, distintos medios, ecosistema informativo.
